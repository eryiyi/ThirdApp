...
import com.example.thirdapp.adapter.ToBeEvaluateAdapter;
...
public class ToBeEvaluate extends BaseActivity implements OnRefreshListener, OnLoadListener{
	MyListViewUpDown lv;
	List<ToBeBean> list;
	ToBeEvaluateAdapter adapter;
	...
	protected void onCreate(Bundle arg0) {
		...
		titlechange.setText(R.string.tobeevaluate);
		...
		adapter = new ToBeEvaluateAdapter(this, list);
