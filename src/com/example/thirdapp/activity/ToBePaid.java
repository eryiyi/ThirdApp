...
import com.example.thirdapp.adapter.ToBexAdapter;
...
public class ToBePaid extends BaseActivity implements OnRefreshListener, OnLoadListener{
	MyListViewUpDown lv;
	List<ToBeBean> list;
	ToBexAdapter adapter;
	...
	protected void onCreate(Bundle arg0) {
		...
		adapter = new ToBexAdapter(this, list);
