...
public class SelectCommunityActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle arg0) {
		...
		adapter = new ItemXiaoquAdapter(lists, SelectCommunityActivity.this);
		...
		if(!StringUtil.isNullOrEmpty(String.valueOf(ThirdApplication.lat))){
			progressDialog = new CustomProgressDialog(SelectCommunityActivity.this , "", R.anim.frame_paopao);
						...
						if (StringUtil.isJson(s)) {
							try {
								...
								if(Integer.parseInt(code) == 200){
									...
									Toast.makeText(SelectCommunityActivity.this, jo.getString("msg"), Toast.LENGTH_SHORT).show();
								}
							} catch (JSONException e) {
								e.printStackTrace();
							}
						} else {
							Toast.makeText(SelectCommunityActivity.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
						}
