...
public class SelectAddressActivity extends BaseActivity implements View.OnClickListener ,OnClickContentItemListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        progressDialog = new CustomProgressDialog(SelectAddressActivity.this , "", R.anim.frame_paopao);
                        ...
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if(Integer.parseInt(code1) == 200){
                                    ...
                                    Toast.makeText(SelectAddressActivity.this, jo.getString("msg"), Toast.LENGTH_SHORT).show();
                                }
                            }catch (Exception e){
                                e.printStackTrace();
                            }
    ...
    private void showSelectImageDialog() {
        deleteWindow = new DeletePopWindow(SelectAddressActivity.this, itemsOnClick);
        //显示窗口
        deleteWindow.showAtLocation(SelectAddressActivity.this.findViewById(R.id.main), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
    }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            ...
                            Toast.makeText(SelectAddressActivity.this, "删除失败", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
