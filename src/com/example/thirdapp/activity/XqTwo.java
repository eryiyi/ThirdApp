...
public class XqTwo extends BaseActivity implements OnClickListener{
	ListView villagelv;
	...
	protected void onCreate(Bundle arg0) {
		...
		adapter = new ItemXiaoquAdapter(lists, XqTwo.this);
		lstv.setAdapter(adapter);
		lstv.setOnItemClickListener(new OnItemClickListener() {
			@Override
			public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
				Community community = lists.get(i);
				Intent intent = new Intent(XqTwo.this, RegisterDetail.class);
		...
		if(!StringUtil.isNullOrEmpty(String.valueOf(ThirdApplication.lat))){
			...
			progressDialog = new CustomProgressDialog(XqTwo.this , "", R.anim.frame_paopao);
						...
						if (StringUtil.isJson(s)) {
							try {
								...
								if(Integer.parseInt(code) == 200){
									...
									Toast.makeText(XqTwo.this, jo.getString("msg"), Toast.LENGTH_SHORT).show();
								}
							} catch (JSONException e) {
								e.printStackTrace();
							}
						} else {
							Toast.makeText(XqTwo.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
						}
