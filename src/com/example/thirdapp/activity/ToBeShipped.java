...
import com.example.thirdapp.adapter.ToBeShippedAdapter;
...
public class ToBeShipped extends BaseActivity implements OnRefreshListener, OnLoadListener{
	MyListViewUpDown lv;
	List<ToBeBean> list;
	ToBeShippedAdapter adapter;
	...
	protected void onCreate(Bundle arg0) {
		...
		titlechange.setText(R.string.tobeshipped);
		...
		adapter = new ToBeShippedAdapter(this, list);
