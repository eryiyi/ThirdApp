...
import com.example.thirdapp.adapter.ToBeRefundAdapter;
...
public class ToBeRefund extends FragmentActivity implements OnRefreshListener, OnLoadListener{
	MyListViewUpDown lv;
	List<ToBeBean> list;
	ToBeRefundAdapter adapter;
	...
	protected void onCreate(Bundle arg0) {
		...
		titlechange.setText(R.string.toberefund);
		...
		adapter = new ToBeRefundAdapter(this, list);
