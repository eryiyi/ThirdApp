...
public class TravelTitleFragment extends BaseFragment implements OnClickListener {
	View view;
	View viewpopup;
	View viewbottom;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.traveltitle, null);
		more = (ImageView) view.findViewById(R.id.more);
		activity = new MainActivity();
		bottomFragment = (BottomFragment) getActivity()
				.getSupportFragmentManager().findFragmentById(R.id.bottombar);
	...
	public void onClick(View v) {
		...
		case R.id.mainpagemall:
			...
			getActivity().getSupportFragmentManager().beginTransaction()
					.replace(R.id.titlefragment, mainpagetilte).commit();
	...
	public void showPopupWindow() {
		...
		// popupWindow.showAtLocation(viewpopup.findViewById(R.id.cancelinvate),
		// Gravity.CENTER, 0, 0);
	}

	public void showPopupWindowShare() {
		popupWindow2 = new PopupWindow(getActivity());
		popupWindow2.setWindowLayoutMode(ViewGroup.LayoutParams.WRAP_CONTENT,
				ViewGroup.LayoutParams.WRAP_CONTENT);
	...
	private void showShareDialog() {
		...
		builder.setItems(new String[] { "邮件", "短信", "其他" },
