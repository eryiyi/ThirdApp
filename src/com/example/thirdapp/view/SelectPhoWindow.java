 ...
 * 类的功能、说明写在此处.
 */
public class SelectPhoWindow extends PopupWindow {
    private TextView camera, cancel, mapstorage;
    private View mMenuView;

    public SelectPhoWindow(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.item_camera, null);
