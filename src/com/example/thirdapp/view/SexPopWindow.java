...
public class SexPopWindow extends PopupWindow {
    ...
    private TextView sex_man, sex_woman, cancel;
    private View mMenuView;

    public SexPopWindow(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.item_dialog_sex, null);
