...
public class ToBeEvaluateAdapter extends BaseAdapter{
	LayoutInflater inflater;
	Context context;
	List<ToBeBean> list;
	ImageView checkx;
	
	public ToBeEvaluateAdapter(Context context, List<ToBeBean> list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		((TextView) convertView.findViewById(R.id.changetext)).setText("买家已签单");
		checkx = (ImageView) convertView.findViewById(R.id.checkx);
		checkx.setImageResource(R.drawable.evaluatern);
		return convertView;
	}
