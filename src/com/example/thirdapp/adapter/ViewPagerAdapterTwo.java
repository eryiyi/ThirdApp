...
public class ViewPagerAdapterTwo extends PagerAdapter {
    ...
    public ViewPagerAdapterTwo(Context cx) {
        mContext = cx;
    }
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        imageLoader.displayImage(InternetURL.INTERNAL_PIC + mPaths.get(position), holder.iv, ThirdApplication.options, animateFirstListener);
