...
public class ToBexAdapter extends BaseAdapter{
	LayoutInflater inflater;
	Context context;
	List<ToBeBean> list;
	
	public ToBexAdapter(Context context, List<ToBeBean> list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			holder = new Holder();
			convertView = inflater.inflate(R.layout.itemtobex, null);
