...
public class ToBeReceiveAdapter extends BaseAdapter{
	...
	List<ToBeBean> list;
	ImageView checkx;
	public ToBeReceiveAdapter(Context context, List<ToBeBean> list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		((TextView) convertView.findViewById(R.id.changetext)).setText("卖家已发货");
		checkx = (ImageView) convertView.findViewById(R.id.checkx);
		checkx.setImageResource(R.drawable.checktrip);
		return convertView;
	}
