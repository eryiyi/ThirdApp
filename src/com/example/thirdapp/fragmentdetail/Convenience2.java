...
public class Convenience2 extends BaseFragment implements OnClickListener,OnRefreshListener, OnLoadListener{
	View view;
	View view2;
	ImageView image1;
	ImageView image2;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		image1.setImageResource(R.drawable.distance);
	...
	public void showPopupWindow(View imageView, int posX){
		...
		if(posX ==  ll*1){
			...
			list.add(bean1);
			PopupTextlBean bean2 = new PopupTextlBean("1000m以下");
			list.add(bean2);
			PopupTextlBean bean3 = new PopupTextlBean("1500m以下");
			list.add(bean3);
			PopupTextlBean bean4 = new PopupTextlBean("2000m以下");
			list.add(bean4);
		}
		if(posX ==  ll*2){
			PopupTextlBean bean1 = new PopupTextlBean("不限");
	...
	public void onClick(View v) {
		...
		case R.id.allcq:
			...
			image1.setImageResource(R.drawable.distanceb);
			break;
		case R.id.rent:
