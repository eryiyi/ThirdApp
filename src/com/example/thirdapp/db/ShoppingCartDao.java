...
public class ShoppingCartDao extends AbstractDao<ShoppingCart, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Goods_cover = new Property(4, String.class, "goods_cover", false, "GOODS_COVER");
        public final static Property Sell_price = new Property(5, String.class, "sell_price", false, "SELL_PRICE");
        public final static Property Goods_count = new Property(6, String.class, "goods_count", false, "GOODS_COUNT");
        public final static Property Dateline = new Property(7, String.class, "dateline", false, "DATELINE");
        public final static Property Is_select = new Property(8, String.class, "is_select", false, "IS_SELECT");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'SHOPPING_CART' (" + //
                ...
                "'GOODS_NAME' TEXT NOT NULL ," + // 3: goods_name
                "'GOODS_COVER' TEXT NOT NULL ," + // 4: goods_cover
                "'SELL_PRICE' TEXT NOT NULL ," + // 5: sell_price
                "'GOODS_COUNT' TEXT NOT NULL ," + // 6: goods_count
                "'DATELINE' TEXT NOT NULL ," + // 7: dateline
                "'IS_SELECT' TEXT NOT NULL );"); // 8: is_select
    }
    ...
    protected void bindValues(SQLiteStatement stmt, ShoppingCart entity) {
        ...
        stmt.bindString(4, entity.getGoods_name());
        stmt.bindString(5, entity.getGoods_cover());
        stmt.bindString(6, entity.getSell_price());
        stmt.bindString(7, entity.getGoods_count());
        stmt.bindString(8, entity.getDateline());
        stmt.bindString(9, entity.getIs_select());
    }
    ...
    public ShoppingCart readEntity(Cursor cursor, int offset) {
        ShoppingCart entity = new ShoppingCart( //
            ...
            cursor.getString(offset + 3), // goods_name
            cursor.getString(offset + 4), // goods_cover
            cursor.getString(offset + 5), // sell_price
            cursor.getString(offset + 6), // goods_count
            cursor.getString(offset + 7), // dateline
            cursor.getString(offset + 8) // is_select
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, ShoppingCart entity, int offset) {
        ...
        entity.setGoods_name(cursor.getString(offset + 3));
        entity.setGoods_cover(cursor.getString(offset + 4));
        entity.setSell_price(cursor.getString(offset + 5));
        entity.setGoods_count(cursor.getString(offset + 6));
        entity.setDateline(cursor.getString(offset + 7));
        entity.setIs_select(cursor.getString(offset + 8));
     }
